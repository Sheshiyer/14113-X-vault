...
**Scope:** Full webapp build from scratch  
**Task Count:** 187 microtasks  
**Duration:** 8 weeks (44 days per power number)  
**Tech Stack:** Next.js + Cloudflare Workers + D1 + Bun
...
**Objective:** Project scaffolding, biorhythm engine, database schema

#### Sprint 1.1: Project Setup (Week 1, Days 1-3)
- [ ] **P1-S1-01** [2h] Initialize Next.js 14 project with TypeScript + Bun
- [ ] **P1-S1-02** [1h] Configure Tailwind CSS with power-number color palette
...
- [ ] **P1-S1-06** [2h] Install dependencies (React Bits MCP, Lucide, NextAuth, etc.)
...
**Objective:** Build reusable UI components, design system implementation

#### Sprint 2.1: Design System (Days 15-17)
**PARALLEL AGENT E: Design Tokens**
- [ ] **P2-S1-01** [2h] Configure Tailwind with power number colors (#FF6B6B, #9B59B6, etc.)
...
**PARALLEL AGENT F: React Bits Integration**
- [ ] **P2-S1-09** [3h] Set up React Bits MCP connection
- [ ] **P2-S1-10** [2h] Pull button components (primary, secondary, ghost)
- [ ] **P2-S1-11** [2h] Pull form components (input, textarea, select)
- [ ] **P2-S1-12** [2h] Pull card components
- [ ] **P2-S1-13** [2h] Pull modal/dialog components
- [ ] **P2-S1-14** [2h] Pull loader/spinner components
- [ ] **P2-S1-15** [2h] Customize components with power number colors
- [ ] **P2-S1-16** [2h] Write component usage docs

#### Sprint 2.2: Core UI Components (Days 18-21)
**PARALLEL AGENT G: Layout Components**
- [ ] **P2-S2-01** [3h] Build navigation header
...
- [ ] **P2-S2-07** [6h] Build biorhythm wheel component (SVG)
...
- [ ] **P2-S2-15** [4h] Build chapter card component (locked/unlocked states)
...
**Objective:** Implement biorhythm → chapter mapping, unlock logic, animations
...
- [ ] **P3-S2-01** [4h] Design unlock animation sequence (0-3s: pulse, 3-6s: transform, etc.)
- [ ] **P3-S2-02** [6h] Build unlock animation with Framer Motion
...
- [ ] **P3-S2-06** [3h] Add sound wave visualization
...
- [ ] **P3-S2-10** [3h] Create unlock modal component
...
**Objective:** Audio player, canticle playback, waveform visualization
...
- [ ] **P4-S1-06** [6h] Build custom audio player component
...
**Objective:** Build all user-facing pages and navigation flows

#### Sprint 5.1: Auth Pages (Days 36-38)
**PARALLEL AGENT O: Auth UI**
- [ ] **P5-S1-01** [3h] Build landing page (hero, value prop, CTA)
...
- [ ] **P5-S2-01** [4h] Build main dashboard layout
...
- [ ] **P6-S2-06** [3h] Design achievement badges (8 achievements)
...
1. **P1-S2-01 to P1-S2-10** — Biorhythm calculator (Week 1)
2. **P3-S1-01 to P3-S1-11** — Unlock logic (Week 4)
3. **P3-S2-01 to P3-S2-09** — 13-second unlock animation (Week 4)
4. **P7-S1-05 to P7-S1-10** — Audio recording (Week 8)
...
1. Birth date + timezone are sufficient for biorhythm calculation
2. Sunrise/sunset data available via external API (e.g., sunrise-sunset.org)
3. Audio files are pre-recorded (or placeholder audio used initially)
4. User completes chapters sequentially (no skipping)
5. Cloudflare free tier is sufficient for beta (13 users)

---

## 🎯 Next Actions

1. **Review this plan** — Confirm scope, adjust task order if needed
2. **Set up project** — Run P1-S1-01 to P1-S1-12 (Project Setup)
3. **Dispatch parallel agents** — Start P1-S2 with 3 agents (Biorhythm, Database, Auth)
