...
export const DetailedAnalysis: React.FC<DetailedAnalysisProps> = ({ onBack, capturedData }) => {
  ...
  return (
    <div className="min-h-screen bg-pip-bg text-pip-text-primary">
      {/* Header */}
      <header className="h-14 sm:h-16 px-3 sm:px-6 flex items-center justify-between border-b border-pip-border bg-pip-dark/50 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2">
          <button className="glass-button p-2" title="Share">
            ...
            <GlassCard className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex gap-1">
                  ...
                  <button 
                    className={`glass-button p-1.5 ${showZones ? 'bg-pip-accent/20 border-pip-accent/50' : ''}`}
          ...
          <div className="lg:col-span-3 space-y-3 sm:space-y-4">
            ...
            <GlassCard className="p-3 sm:p-4">
              ...
              <button
                onClick={handleExportPDF}
                disabled={isExporting}
                className="w-full glass-button py-3 text-center flex items-center justify-center gap-2 hover:bg-pip-accent/20 hover:border-pip-accent/50"
              >
