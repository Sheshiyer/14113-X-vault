...
export const MetricsGuide: React.FC<MetricsGuideProps> = ({ onBack }) => {
  return (
    <div className="min-h-screen flex flex-col bg-pip-bg text-pip-text-primary font-sans">
      {/* Header */}
      <header className="glass-chip !rounded-none border-b border-white/10 px-4 py-3 flex items-center gap-4 sticky top-0 z-10 backdrop-blur-xl">
        <button
          onClick={onBack}
          className="p-2 rounded-lg hover:bg-white/10 text-pip-text-secondary hover:text-white transition-colors"
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8">
        <div className="max-w-7xl mx-auto space-y-10">
          ...
          <section>
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {SCORE_DEFINITIONS.map((metric) => (
                <div 
                  key={metric.name} 
                  className="group relative bg-gradient-to-br from-white/[0.07] to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl p-5 hover:border-pip-accent/50 hover:shadow-lg hover:shadow-pip-accent/10 transition-all duration-300"
                >
                  {/* Header */}
          ...
          <section>
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              <div className="group relative bg-gradient-to-br from-white/[0.07] to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl p-5 hover:border-pip-accent/50 hover:shadow-lg hover:shadow-pip-accent/10 transition-all duration-300">
