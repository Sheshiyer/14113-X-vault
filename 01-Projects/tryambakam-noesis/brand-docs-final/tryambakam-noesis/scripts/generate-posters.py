...
Below: "{tagline}" in Panchang Light, Muted Silver (#8A9BA8).
...
Camera: . Sacred Gold (#C5A017) highlights,
Witness Violet (#2D0050) deep shadows. 2px Muted Silver borders. 8K."""
