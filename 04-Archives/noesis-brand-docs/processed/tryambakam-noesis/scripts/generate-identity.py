#!/usr/bin/env python3
"""
Tryambakam Noesis — Brand Identity (2B Seal + 2C Logo)
...
PROMPT_2B = """Tryambakam Noesis brand seal emblem. Oxidized copper circular seal
...
PROMPT_2C = """Tryambakam Noesis stained-glass logo emboss. The brand sigil
