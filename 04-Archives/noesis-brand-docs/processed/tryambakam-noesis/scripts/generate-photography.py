#!/usr/bin/env python3
"""
Tryambakam Noesis — Product Photography (4A + 4B)
...
PROMPT_4A = """Tryambakam Noesis product design catalog page. Top section:
...
PROMPT_4B = """Tryambakam Noesis product collection flat-lay. 5 objects
