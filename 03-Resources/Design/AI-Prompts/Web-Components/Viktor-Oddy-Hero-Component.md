# Viktor Oddy - React/Tailwind Hero Component

Source: [https://x.com/viktoroddy/status/2019727896500400457](https://x.com/viktoroddy/status/2019727896500400457)

## Overview
A prompt for creating a responsive, full-screen Hero section using React and Tailwind CSS. The design features a background video, specific typography constraints, and a custom SVG-based CTA button.

## Visual Demos
- [hero_demo_1.mp4](Images/Viktor-Oddy/hero_demo_1.mp4)
- [hero_demo_2.mp4](Images/Viktor-Oddy/hero_demo_2.mp4)

## The Hero Component Prompt
### Prompt
...
>    - Video URL: https://video.twimg.com/amplify_video/2019727765327728640/vid/avc1/1536x1080/brxNTJCddMbIn_fh.mp4?tag=21 (Referenced as 6_044704_dd33cb15-c23f-4cfc-aa09-a0465d4dcb54.mp4 in original thread)
> 
