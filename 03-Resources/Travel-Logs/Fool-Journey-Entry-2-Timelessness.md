...
domain: occult, systems-thinking, gene-keys, time-perception
tags: [gene-key-5, gene-key-23, timelessness, rahu, mercury, breath-protocol, 7-1-3, time-dilation, room-3]
enneagram_type: 5
...
- GK-23: From complexity to simplicity (one line)
- Rahu swallowing time
- Mercury's silence
- Technology glitch as spiritual opening

**Connections:**
- [[Gene-Key-5]] — Patience and the dissolution of time pressure
- [[Gene-Key-23]] — Simplicity, compression to essence
- [[Tarot-Seven-of-Wands]] — The defended hilltop
- [[Tarot-Knight-of-Swords]] — Poised blade
- [[Tarot-Three-of-Wands]] — Horizon air
- [[Rahu]] — The eclipse, swallowing
- [[Mercury]] — Precision, communication

**Practical Extract:**
Timelessness as state, not escape. The clock disappears when presence arrives. GK-5's gift available through ritual, not avoidance.
